...
// Retired endpoint: never return fabricated contacts to old clients.
router.post('/generate-leads', (req, res) => {
    res.status(410).json({ error: 'Lead discovery has moved to /api/research/leads. Please refresh the application.' });
});
